...
-- depends_on: {{ source('public', '_airbyte_raw_deal_fields') }}
select
    ...
    {{ json_extract('table_alias', '_airbyte_data', ['mandatory_flag'], ['mandatory_flag']) }} as mandatory_flag,
    ...
    {{ json_extract_scalar('_airbyte_data', ['deal_remote_id'], ['deal_remote_id']) }} as deal_remote_id,
    ...
    {{ json_extract_scalar('_airbyte_data', ['deal_custom_field_key'], ['deal_custom_field_key']) }} as deal_custom_field_key,
    ...
    {{ json_extract_array('_airbyte_data', ['pipeline_ids'], ['pipeline_ids']) }} as pipeline_ids,
    {{ json_extract_scalar('_airbyte_data', ['important_flag'], ['important_flag']) }} as important_flag,
    _airbyte_ab_id,
    _airbyte_emitted_at,
    {{ current_timestamp() }} as _airbyte_normalized_at
from {{ source('public', '_airbyte_raw_deal_fields') }} as table_alias
-- deal_fields
where 1 = 1
