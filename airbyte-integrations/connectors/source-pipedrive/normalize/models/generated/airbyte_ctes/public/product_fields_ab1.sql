...
-- depends_on: {{ source('public', '_airbyte_raw_product_fields') }}
select
    ...
    {{ json_extract_scalar('_airbyte_data', ['use_field'], ['use_field']) }} as use_field,
    {{ json_extract_scalar('_airbyte_data', ['json_column_flag'], ['json_column_flag']) }} as json_column_flag,
...
from {{ source('public', '_airbyte_raw_product_fields') }} as table_alias
-- product_fields
where 1 = 1
