...
emit_record_scenario_single_stream = (
    ...
    .set_expected_logs(
        [
            {
                "level": "ERROR",
                "message": f"{FileBasedSourceError.ERROR_PARSING_RECORD.value} stream=stream1 file=c.csv line_no=2",
            },
        ]
    )
).build()
...
emit_record_scenario_multi_stream = (
    ...
    .set_expected_logs(
        [
            {
                "level": "ERROR",
                "message": f"{FileBasedSourceError.ERROR_PARSING_RECORD.value} stream=stream1 file=a/a3.csv line_no=2",
            },
        ]
    )
).build()
...
wait_for_rediscovery_scenario_single_stream = (
    ...
    .set_expected_logs(
        [
            {
                "level": "INFO",
                "message": "Stopping sync in accordance with the configured validation policy. Records in file did not conform to the schema. stream=stream1 file=a.csv validation_policy=wait_for_discover",
            },
        ]
    )
).build()
...
wait_for_rediscovery_scenario_multi_stream = (
    ...
    .set_expected_logs(
        [
            {
                "level": "INFO",
                "message": "Stopping sync in accordance with the configured validation policy. Records in file did not conform to the schema. stream=stream1 file=a/a1.csv validation_policy=wait_for_discover",
            },
            {
                "level": "INFO",
                "message": "Stopping sync in accordance with the configured validation policy. Records in file did not conform to the schema. stream=stream2 file=b/b2.csv validation_policy=wait_for_discover",
            },
        ]
    )
).build()
